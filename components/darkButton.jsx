    ...
    return (
        <div>
            <div className="form-check form-switch">
                <label className="form-check-label"   htmlFor="flexSwitchCheckDefault">{modeText} mode <i className={`fa ${mode}`} ></i></label>
                <input className="form-check-input" onClick={handleDarkMode}  type="checkbox" id="flexSwitchCheckDefault" />
</div>
        </div>
    )
}
